Feature: Login
  As a user I should be ale to login to the app


  Scenario: Login with valid credentials
  As a user I should be ale to login using valid username and password
  ...
  As a user I should not be ale to login using invalid username
  ...
  As a user I should not be ale to login using invalid password
  ...
  As a user I should not be ale to login using invalid username and/or password
